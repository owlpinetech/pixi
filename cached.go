...
func NewFifoCacheReadLayer(backing io.ReadSeeker, header *PixiHeader, layer *Layer, maxSize int) *FifoCacheReadLayer {
...
func (c *FifoCacheReadLayer) Header() *PixiHeader {
	return c.header
}
...
func NewFifoCacheLayer(backing io.ReadWriteSeeker, header *PixiHeader, layer *Layer, maxSize int) *FifoCacheLayer {
